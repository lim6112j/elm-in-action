...
var $author$project$PhotoGroove$initModel = {chosenSize: $author$project$PhotoGroove$Large, hue: 5, noise: 5, ripple: 5, status: $author$project$PhotoGroove$Loading};
		...
		function () {
			...
			switch (_v0.$) {
				case 'Loaded':
					var photos = _v0.a;
					var url = _v0.b;
					return A3($author$project$PhotoGroove$viewLoaded, photos, url, model);
				case 'Loading':
					return _List_Nil;
				default:
